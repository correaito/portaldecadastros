...
$infmp="SELECT * from cadservp where ticket='$ticket'"; // Consulta no BD, todas as entradas com o número do ticket capturado
...
<form action ="/listaservpres/salvaralteracao.php" method="post" class="form-horizontal">
<fieldset>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="Ticket" name="ticket" value="<? echo $vdesc;?>" type="text" readonly="yes"placeholder="" class="input-xlarge">
    </div>
</div>
...
<div class="control-group">
  <label class="control-label" for="Ticket">Canais de distribuição</label>
  <div class="controls">
...
$sql= "SELECT * FROM logservp where ticket=$ticket ORDER BY data DESC"; 
...
<!-- Caixa de comentário -->
<form action ="/listaservpres/coment.php?ticket=<?echo $ticket ?>" method="post">
<div class="control-group">
