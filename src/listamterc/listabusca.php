...
include("../config.php"); // conexão do BD
session_start();
...
$sql = "SELECT * FROM cadmater where (descricao LIKE '%$busca%' OR codfab LIKE '%$busca%' OR descricao LIKE '%$busca%' OR fab LIKE '%$busca%' OR comentario LIKE '%$busca%') ORDER BY ticket DESC LIMIT $inicio,$limite";

$resultado = mysql_query($sql);

// consulta no BD sem limite
$buscar = "SELECT * FROM cadmater where (descricao LIKE '%$busca%' OR codfab LIKE '%$busca%' OR descricao LIKE '%$busca%' OR fab LIKE '%$busca%' OR comentario LIKE '%$busca%') ORDER BY ticket DESC";

$consulta = mysql_query($buscar);
...
echo "<a href=../listamterc/listabusca.php?busca=$busca&pag=".($pagina-1).">Anterior</a>";    
     }
elseif (($pagina == 1) and ($pagina < $total_paginas))
     {
echo "<a href=../listamterc/listabusca.php?busca=$busca&pag=".($pagina+1).">Próximo</a>"; 
     }
elseif (($pagina > 1) and ($pagina < $total_paginas)) {
echo "<a href=../listamterc/listabusca.php?busca=$busca&pag=".($pagina-1).">Anterior</a>";      
echo "<a href=../listamterc/listabusca.php?busca=$busca&pag=".($pagina+1).">Próximo</a>";
