...
$usuariologado = $_SESSION['login']; // Memoriza a session na variável
...
$pageTitle = 'Portal de Cadastro - Área do Usuário Admin'; 
?>
        ...
        <div class="span3">
            <div style="background-color: #1a365d; color: white; padding: 20px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                    <span style="font-size: 14px; opacity: 0.8;">Total Solicitações</span>
