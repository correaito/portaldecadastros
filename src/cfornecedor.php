...
<?php $pageTitle = 'Portal de Cadastro - Fornecedor'; ?>
...
alert('Você esqueceu de marcar pelo menos uma opção em "Centro".');
</script>
<?php } ?>
...
<div class="section">
  <p><i class="icon-th-list icon-white"></i> Cadastro de Fornecedor</p>     
...
<form name="contactform" method="post" action="mailer_forn.php" class="form-horizontal" role="form">
<fieldset>
...
<div class="control-group">
  ...
  <div class="controls">
    <select id="selectbasic" name="grupoconta" class="input-xlarge" required="">
      ...
      <option>Coligada/Contrada</option>
      <option>Serviços</option>
      <option>Fornecedor Estrangeiro</option>
      <option>Fornecedor Pessoa Jurídica</option>
      <option>Ocasionais</option>
      <option>Tributos</option>
      <option>Financiamentos</option>
      <option>Fornecedor Pessoa Física</option>
      <option>Fornecedor/Cliente</option>
    </select>
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <label class="checkbox" for="checkboxes-0">
      <input type="checkbox" name="centros[]" value="PA01">
      Matriz
    </label>
    <label class="checkbox" for="checkboxes-1">
      <input type="checkbox" name="centros[]" value="PA02">
      Porto
    </label>
    <label class="checkbox" for="checkboxes-2">
      <input type="checkbox" name="centros[]" value="PG01">
      Ponta Grossa
    </label>
    <label class="checkbox" for="checkboxes-3">
      <input type="checkbox" name="centros[]" value="IT01">
      Itajaí
    </label>
    <label class="checkbox" for="checkboxes-4">
      <input type="checkbox" name="centros[]" value="RG01">
      Rio Grande
    </label>
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="textinput" name="cnpj" type="text" placeholder="CPF/CNPJ" maxlength="18" onKeyPress="return(soNums(event))" onBlur="validar(this)" class="input-xlarge" required="">
    </div>
</div>
...
<div class="control-group">
  <label class="control-label" for="textinput">CNH</label>
  <div class="controls">
    <input id="textinput" name="cnh" type="text" pattern="\d{11}"  placeholder="XXXXXXXXXXX" class="input-xlarge">
   </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="textinput" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" name="email2" type="text" placeholder="nome@dominio.com" class="input-xlarge">
   </div>
</div>
